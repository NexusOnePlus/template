    ...
    do {
        ...
        switch (op) {
            case 1:
                ...
                cout << "-------------------------------------------------" << endl;
                cout << endl << "Expresion Infija: "; cin >> ei;
                n =  strlen(ei);
                prefija(ei, n);
                system("pause");
                break;
            ...
            case 3:
                ...
                cout << "-------------------------------------------------" << endl;
                cout << endl << "Expresion Prefija: "; cin >> ei;
                n =  strlen(ei);
                evpre(ei, n);
                system("pause");
                break;
            case 4:
                ...
                cout << "-------------------------------------------------" << endl;
                cout << endl << "Expresion Postfija: "; cin >> ei;
                n =  strlen(ei);
                evpost(ei, n);
                system("pause");
                break;
        ...
        if(ei[i] == ')'){
            ...
            if (ei[i] == '(')
            {
                ...
                if (isdigit(ei[i]))
                {
                    ...
                    while (tope > -1 && prioridad(ei[i]) < prioridad(pila[tope]))
                    {
                        j++;
                        epre[j] = pila[tope];
                        tope--;
